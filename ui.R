...
###############################################
#
# Second UI, with dynamic tabs

uiPublic2 <- fluidPage(id="main", #title="MSU Sustainability Dashboard",
  fluid=T,
  position="static-top",
  selected="tabMap",
  inverse=T, #For dark top
  ...
  #Start first tab, Info
  mainPanel(title = "Home", value="tabHome",
    tags$div(align="center",
      tags$h1("Montana State University Sustainability Dashboard"),
      tags$p("click on an icon to explore data, or ",
        actionLink(inputId="openTabAbout", label="learn about the Sustustainability Dashboard")),
...
shinyjs::hidden(
  ########### Energy ################
  mainPanel(title = "Energy", value="tabEnergy", icon=icon("lightbulb-o"),
    fluidRow(column(10, offset=1,
      tags$h1("Energy"),
      tags$p("For electricity and natural gas usage, MSU's ",
      tags$a(href="http://www.montana.edu/sustainability/projectsandinitiatives/climateactionplan.html", "Climate Action Plan"),
...
shinyjs::hidden(
  ########### Waste ################
  mainPanel(title = "Waste", value="tabWaste", icon=icon("trash"),
...
shinyjs::hidden(
  ########### GHG ################
  mainPanel(title = "GHG", value="tabGHG", icon=icon("globe"),
    tags$h1("Greenhouse Gas Emissions"),
    HTML("Climate Action plan")
  ),

  ########### Water ################
  mainPanel(title = "Water", value="tabWater", icon=icon("tint"),
    fluidRow(column(10, offset=1,
    tags$h1("Water"),
        tabsetPanel(
          tabPanel("Water Use",
...
shinyjs::hidden(
  ########### Leed ################
  mainPanel(title = "Buildings & Landscaping", value="tabMap", icon=icon("home"),
    div(class="outer",
      buildingMapUI("leafletMap"),
...
shinyjs::hidden(
 ########### Projects ################
 mainPanel(value="tabProjects",
    tags$h1("Projects")
 )),

shinyjs::hidden(
  ########### About ################
    mainPanel("About", value="tabAbout",
    fluidRow(column(10, offset=1,
        h2("Data Sources"),
        dataSourceUI("dataSources")
      )
